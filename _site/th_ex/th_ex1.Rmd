...
kids_plot<- ggplot(data=dt_frame, aes(x=age_group, y=cnt)) +
           ...
           ggtitle("Comparison among participants with children and those without children")
kids_plot
```
...
happiness_plot<- ggplot(data=dt_frame, aes(x=age_group, y=avg_happiness)) +
                 ...
                 ggtitle("The happiness index of participants with children compared with participants without children")
happiness_plot
```
...
edu_plot<- ggplot(data=dt_frame, aes(x=age_group, y=avg_happiness))+
           ...
           ggtitle("Comparison among participants with different education level")
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE}
summary_plot <- ((happiness_plot / edu_plot) | agePlot) + 
                plot_annotation(tag_levels = 'I')
summary_plot <- summary_plot & theme_economist()
